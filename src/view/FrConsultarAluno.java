 ...
 */
public class FrConsultarAluno extends javax.swing.JDialog {

    /**
     * Creates new form FrConsultarAluno
     */
    public FrConsultarAluno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrConsultarAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrConsultarAluno dialog = new FrConsultarAluno(new javax.swing.JFrame(), true);
